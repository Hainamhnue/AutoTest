...
@section('title','Xem điểm đánh giá')
@section("content")
    <!-- Page Content -->
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title">Xem điểm đánh giá</h3>
                            ...
                            <table id="datatables-buttons"class="table" >
                                ...
                                <?php $count = 1 ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('donvi/evaluation-user/'.$show->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                                            <a href="#deleteModal" class="btnDelete btn btn-danger" rel="" id="{{$show->id}}" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <script type="text/javascript">
        ...
        $(".btnDelete").on("click",function(){
            $.ajax({
                url:"donvi/show-scores-faculty/destroy/"+this.id,

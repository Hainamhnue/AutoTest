...
"></i></a>
            <div class="top-left-part"><a class="logo" href="{{route('home.index')}}"><b><img src="{{asset('../plugins/images/pixeladmin-logo.png')}}" alt="home" /></b><span class="hidden-xs"><img src="{{asset('../plugins/images/pixeladmin-text.png')}}" alt="home" /></span></a></div>

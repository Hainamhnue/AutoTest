                    ...
                    <div class="white-box">
                        <form class="form-horizontal form-material">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control is-valid" id="validationServer03" placeholder="" required value="0{{$user->phone}}" name="phone">
                            </div>
                            <div class="form-group">
                                <label for="validationServer04">Địa chỉ: </label>
                                <input type="text" class="form-control is-valid" id="validationServer04" value="{{$user->bomon}}" name="address">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <a href="{{url('donvi/quan-ly/'.$user->id.'/edit')}}" class="btn btn-success active" role="button" aria-pressed="true">Update Profile</a>
                                </div>
                            </div>
                        </form>
                    </div>

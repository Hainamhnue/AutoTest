...
@section('title','Quản lí tiêu chí đánh giá đơn vị')
@section("content")
<!-- Page Content -->
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <!-- <a href="http://wrappixel.com/templates/pixeladmin/" target="_blank" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Upgrade to Pro</a> -->
                <ol class="breadcrumb">
                    ...
                    <li class="active">Quản lí tiêu chí đánh giá đơn vị</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">Quản lí tiêu chí đánh giá đơn vị</h3>
...
<script type="text/javascript">
    ...
    $(".btnDelete").on("click",function(){
        $.ajax({
            url: "criteria-faculty/destroy/"+this.id,
            success: function (data){
                $.toast({
                    heading: 'Thông báo',
                    text: data.message,
